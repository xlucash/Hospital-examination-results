...
public class SignupDoctorRequest {
    ...
    public SignupDoctorRequest(String email, String password, String name, String surname, LocalDate dateOfBirth, String pesel, String phoneNumber, String streetAddress, String house, String apartment, String city, String postalCode, String licenseNumber, String specialization) {
        this.email = email;
